...
enum class ViewerAction(
    ...
    SUSPEND_MENU(R.id.action_suspend, R.drawable.ic_pause_circle_filled, R.string.menu_suspend, MENU_ONLY),
    ...
    PLAY_MEDIA(R.id.action_replay_media, R.drawable.ic_replay_media, R.string.replay_media, DISABLED),
    ...
    private val defaultBindings: List<ReviewerBinding> get() =
        when (this) {
            ...
            PAUSE_AUDIO -> listOf(keycode(KeyEvent.KEYCODE_5))
